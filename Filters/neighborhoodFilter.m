function [data_index_out] = neighborhoodFilter_old(data_index,target_index,index_img,neighborhood)
...
indexes(indexes==0)=[];         % Scrap from data_index all elements that are also in indices
data_index_out = data_index;
data_index_out(indexes) = [];
end
